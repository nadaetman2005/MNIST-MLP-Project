...
def flatten_data(dataset):
    ...
    for img, label in dataset:
        ...
        y.append(label)
    # تحويل لـ numpy array أولاً عشان السرعة
...
# تقسيم training إلى training و validation
val_size = 10000
...
# ============================================
# PART 6: BASELINE MODEL (Hidden: 128, 64 - LR: 0.01)
# ============================================
print("\n" + "="*60)
...
# ============================================
# PART 7: EXPERIMENT 1 - DIFFERENT HIDDEN LAYER SIZES
# (Modified: 64→32 instead of 128→64 - but NOT too small)
# ============================================
print("\n" + "="*60)
...
# ============================================
# PART 8: EXPERIMENT 2 - DIFFERENT LEARNING RATE (0.005)
# ============================================
print("\n" + "="*60)
...
# ============================================
# PART 9: VISUALIZATION - Loss Curves
# ============================================
...
# ============================================
# PART 10: RESULTS COMPARISON TABLE
# ============================================
print("\n" + "="*60)
